...
class ImmersiveInsetsContractTest {
    ...
    fun fullscreenScreensKeepPersistentCameraSafeInsets() {
        ...
        val emulationMenu = sourceRoot
            .resolve("com/sbro/emucorec/ui/emulation/EmulationMenu.kt")
            .readText()
        assertTrue(
        ...
        val emulationOverlay = sourceRoot
            .resolve("com/sbro/emucorec/ui/emulation/EmulationOverlay.kt")
            .readText()
        assertTrue(
        ...
        listOf(
            ...
            val source = sourceRoot
                .resolve("com/sbro/emucorec/ui/$relativePath")
                .readText()
            assertTrue(
