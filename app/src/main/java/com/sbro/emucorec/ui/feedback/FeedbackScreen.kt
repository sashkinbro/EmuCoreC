...
package com.sbro.emucorec.ui.feedback
...
import com.sbro.emucorec.feedback.FeedbackAttachment
import com.sbro.emucorec.feedback.FeedbackAttachmentError
import com.sbro.emucorec.feedback.FeedbackAttachmentInspector
import com.sbro.emucorec.feedback.FeedbackLimits
import com.sbro.emucorec.feedback.FeedbackUploadScheduler
...
fun FeedbackScreen(onBackClick: () -> Unit) {
    ...
    var games by remember { mutableStateOf(emptyList<InstalledPs3Game>()) }
