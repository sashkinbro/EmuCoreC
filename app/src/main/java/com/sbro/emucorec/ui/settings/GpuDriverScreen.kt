...
import com.sbro.emucorec.core.AdrenoFamily
import com.sbro.emucorec.core.GpuDriverMatch
import com.sbro.emucorec.core.GpuDriverRecommendations
import com.sbro.emucorec.core.InstalledGpuDriver
import com.sbro.emucorec.core.RemoteGpuDriver
import com.sbro.emucorec.core.SnapdragonGpuProfile
...
fun GpuDriverScreen(
    ...
    val gameSettingsRepository = remember(context) { Ps3GameSettingsRepository(context) }
    val gameScopedTitleId = targetTitleId?.takeIf(String::isNotBlank)
    var gameConfig by remember(gameScopedTitleId) { mutableStateOf<Ps3CoreConfig?>(null) }
...
private fun InstalledDriverRow(
    ...
    Surface(
        ...
        Row(
            ...
            OutlinedButton(shape = neonButtonShape(), onClick = onRemove) {
                Icon(Icons.Rounded.Delete, contentDescription = null)
            }
        }
    }
