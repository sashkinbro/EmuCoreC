...
import com.sbro.emucorec.data.Ps3CatalogEntry
...
private fun buildMeta(game: Ps3CatalogEntry): String {
...
private fun compatibilityContainerColor(state: Ps3CompatibilityState): Color {
    return when (state) {
        Ps3CompatibilityState.PLAYABLE -> Color(0xEAF1FAEE)
        Ps3CompatibilityState.INGAME_MORE -> Color(0xEAEDF8F6)
        Ps3CompatibilityState.INGAME_LESS -> Color(0xEAEAF3FD)
        Ps3CompatibilityState.MENU -> Color(0xEAEAF8FB)
        Ps3CompatibilityState.INTRO -> Color(0xEAFDF4E3)
        Ps3CompatibilityState.BOOTABLE -> Color(0xEAFDF0E2)
        Ps3CompatibilityState.NOTHING -> Color(0xEAFCEAEA)
        Ps3CompatibilityState.UNKNOWN -> Color(0xEAF2F3F5)
    }
}
