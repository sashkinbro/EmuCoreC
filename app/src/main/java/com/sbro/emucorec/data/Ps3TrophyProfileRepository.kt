...
class Ps3TrophyProfileRepository(private val context: Context) {
    ...
    private fun summarize(sets: List<Ps3TrophySet>): PlayerTrophySummary {
    ...
    private fun Ps3TrophySet.toStat(): PlayerTrophyStat {
        var platinum = 0
        var gold = 0
        var silver = 0
        var bronze = 0
        ...
        trophies.forEach { trophy ->
            ...
            totalPoints += points
            when (trophy.grade) {
                Ps3TrophyGrade.Platinum -> platinum++
                Ps3TrophyGrade.Gold -> gold++
                Ps3TrophyGrade.Silver -> silver++
                Ps3TrophyGrade.Bronze -> bronze++
                Ps3TrophyGrade.Unknown -> Unit
            }
            if (trophy.unlocked) {
                earnedPoints += points
    ...
    companion object {
        ...
        fun pointsFor(grade: Ps3TrophyGrade): Int = when (grade) {
            Ps3TrophyGrade.Platinum -> POINTS_PLATINUM
            Ps3TrophyGrade.Gold -> POINTS_GOLD
            Ps3TrophyGrade.Silver -> POINTS_SILVER
            Ps3TrophyGrade.Bronze -> POINTS_BRONZE
            Ps3TrophyGrade.Unknown -> 0
        }
    }
}
